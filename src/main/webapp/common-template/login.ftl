...
<script type="text/javascript" src="${staticServePath}/js/lib/crypto/crypto-js.js" charset="utf-8"></script>
<script type="text/javascript" src="${staticServePath}/js/lib/crypto/aes.js" charset="utf-8"></script>
